export default {
    accounts: {
      ...
      selfDataImportTitle: 'Import temporary accounts',
      selfDataImportHint: 'Upload JSON exported from account management to import its account records in bulk.',
      selfDataImportWarning: 'To protect shared infrastructure, bundled proxies are not created or modified. Accounts belong to you and start unschedulable; select an existing shared proxy and groups after import.',
