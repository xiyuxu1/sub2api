export default {
    accounts: {
      ...
      selfDataImportTitle: '导入临时账号',
      selfDataImportHint: '上传原账号管理导出的 JSON 文件，批量导入其中的账号。',
      selfDataImportWarning: '为保护共享基础设施，文件中的代理不会创建或修改；账号会归属当前用户、默认不可调度，导入后可在编辑页选择现有共享代理和分组。',
      dataImportFile: '数据文件',
