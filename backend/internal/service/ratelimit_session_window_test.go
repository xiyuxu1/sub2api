...
func (m *sessionWindowMockRepo) ListPublicAccounts(context.Context, pagination.PaginationParams, string, string) ([]Account, *pagination.PaginationResult, error) {
	panic("unexpected")
}
func (m *sessionWindowMockRepo) ListAllWithFilters(context.Context, string, string, string, string, int64, int64, string) ([]Account, error) {
	panic("unexpected")
}
