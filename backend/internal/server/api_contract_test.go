...
func (s *stubAccountRepo) ListAllWithFilters(context.Context, string, string, string, string, int64, int64, string) ([]service.Account, error) {
	return nil, nil
}

func (s *stubAccountRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID, ownerUserID int64, privacyMode string) ([]service.Account, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}

func (s *stubAccountRepo) ListPublicAccounts(ctx context.Context, params pagination.PaginationParams, platform, search string) ([]service.Account, *pagination.PaginationResult, error) {
	return nil, nil, errors.New("not implemented")
}
